...
self.wpn_fps_snp_tti.override.wpn_fps_upg_m4_m_quad = {stats = {extra_ammo = 20, concealment = -2, total_ammo_mod = 10}}
self.wpn_fps_snp_tti.override.wpn_fps_ass_l85a2_m_emag = {a_obj = "a_m_emag", stats = {extra_ammo = 5, concealment = -1, total_ammo_mod = 10}}
self.wpn_fps_snp_tti.override.wpn_fps_upg_m4_m_l5 = {stats = {extra_ammo = 5, concealment = -1, total_ammo_mod = 10, recoil = 1}}
self.wpn_fps_snp_tti.override.wpn_fps_m4_upg_m_quick = {stats = {extra_ammo = 5, concealment = -2, total_ammo_mod = 10, reload = 10}}
